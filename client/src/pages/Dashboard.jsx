      ...
      {user.role === 'admin' && (
        <div className="admin-section">
          <div className="actions card">
            ...
            <p style={{ color: 'var(--text-gray)' }}>Welcome to the admin panel. Here you can manage all aspects of the JobPortal.</p>
            <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}>
              <button className="btn btn-primary">Manage Users</button>
              <button className="btn btn-outline">Manage Jobs</button>
            </div>
          </div>
        </div>
      )}
